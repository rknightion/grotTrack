...
updated_date: '2026-08-14 16:31'
---
> **Imported verbatim from `/Users/rob/repos/agent-fanout-generic.md` on 2026-08-14.**
> This in-repo copy is authoritative for GrotTrack. Do not summarise, compress or adapt it.
> When the source changes, the edit is not finished until every consuming repo has been
